...
JENKINS_ACTION_TAG=jenkins-local/jenkinsfile-action
...
docker build -t ${JENKINSFILE_RUNNER_TAG} -f out/tmp/output/Dockerfile out/tmp/output/
docker build -t ${JENKINS_ACTION_TAG} -f Dockerfile .	